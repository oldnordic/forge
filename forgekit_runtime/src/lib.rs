...
// Re-export forgekit_core types
pub use forgekit_core::{FlushStats, IncrementalIndexer, PathFilter, QueryCache, WatchEvent, Watcher};
...
impl ForgeRuntime {
    ...
    pub async fn with_config(
        ...
        let store = Arc::new(
            forgekit_core::UnifiedGraphStore::open(&codebase_path, forgekit_core::BackendKind::default())
                .await
