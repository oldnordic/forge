...
pub struct GraphQueryTool {
    forge: forge_core::Forge,
}

impl GraphQueryTool {
    pub fn new(forge: forge_core::Forge) -> Self {
...
fn format_symbols(symbols: &[forge_core::types::Symbol]) -> String {
    if symbols.is_empty() {
...
fn format_references(refs: &[forge_core::types::Reference]) -> String {
    if refs.is_empty() {
...
fn format_cycles(cycles: &[forge_core::types::Cycle]) -> String {
    if cycles.is_empty() {
...
fn format_impacted(impacted: &[forge_core::graph::ImpactedSymbol]) -> String {
