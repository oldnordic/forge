...
use forgekit_runtime::ForgeRuntime;
use std::path::Path;
use std::sync::Arc;
...
impl Agent {
    ...
    pub fn runtime_stats(&self, runtime: &ForgeRuntime) -> forgekit_runtime::RuntimeStats {
        runtime.stats()
    }
}
...
pub struct CachingLlmProvider {
    ...
    cache: forgekit_core::QueryCache<String, String>,
}
