...
pub struct WorkflowBuilder {
    ...
    forge: Option<Arc<forgekit_core::Forge>>,
}
...
impl WorkflowBuilder {
    ...
    /// ```
    pub fn with_auto_detect(mut self, forge: &forgekit_core::Forge) -> Self {
...
mod tests {
    ...
    fn test_builder_with_auto_detect() {
        ...
        let forge = rt.block_on(async {
            Forge::open_with_backend(temp_dir.path(), forgekit_core::storage::BackendKind::SQLite)
                .await
                .unwrap()
        });
