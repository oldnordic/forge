...
async fn main() {
    ...
    use forgekit_agent::chat::conversation::Conversation;
    use forgekit_agent::chat::providers::ollama::OllamaChatProvider;
    use forgekit_agent::chat::providers::ChatProvider;
    use forgekit_agent::chat::tools::registry::{AsyncTool, BuiltinToolRegistry, ToolRegistry};
    use forgekit_agent::chat::tools::types::{ToolCall, ToolDef};
    use forgekit_agent::chat::types::{ChatMessage, ContentBlock};
