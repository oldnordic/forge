...
use forgekit_agent::chat::sandbox::Sandbox;
use forgekit_agent::chat::tools::builtins::ShellExecTool;
use forgekit_agent::chat::AsyncTool;
...
async fn main() {
    ...
    let shared = forgekit_agent::chat::sandbox::shared_sandbox(Some(sandbox));
